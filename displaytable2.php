...
{	
	...
	$price=getprice2(date("d"),"close",$lines);
	$open=getprice2(date("d"),"open",$lines);
	$closepreviousday=getprice2(date("d",strtotime("-1 weekdays")),"close",$lines);
	...
	$price0905=getprice2(date("d"),5,$lines);	
	...
	$price0910=getprice2(date("d"),10,$lines);	
	...
	$price10day=getprice2(date("d",strtotime("-10 weekdays")),"open",$lines);
	$price3day=getprice2(date("d",strtotime("-3 weekdays")),"open",$lines);
